...
/**
 * VFS operation to copy files from source to target directory.
 *
 */
public class VfsCopy extends AbstractVfsOperation {

    /**
     * Performs copy operation with delegation.
     * 
    ...
    protected int executeImpl(VfsOperationOptions options) throws FileSystemException {
        return getOperationDelegate().copy(options);
    }
     ...
     *             source or target directory not given
     */
    @Override
